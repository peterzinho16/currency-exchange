...
import { AuthServerApiRequestService } from './shared/service/auth-server-api-request.service';
...
@NgModule({
    ...
    providers: [ExchangeRatesApiRequestService, CurrencyExchangeService, AuthServerApiRequestService],
